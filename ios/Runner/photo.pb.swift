...
extension Photos: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "Photos"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "photos"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 5: try decoder.decodeSingularInt64Field(value: &_storage._fileSize)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._fileSize != 0 {
        try visitor.visitSingularInt64Field(value: _storage._fileSize, fieldNumber: 5)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
